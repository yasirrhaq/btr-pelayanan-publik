...
class AdminCategoryController extends Controller
{
    ...
    {
        $category = Category::withCount('posts')->where('id', '=', $category->id)->get();
        
        if ($category[0]->posts_count > 0) {
            return redirect('/dashboard/categories')->with('deleteError', 'Kategori tidak bisa dihapus karena masih ada berita yang menggunakan kategori ini!');
        }
