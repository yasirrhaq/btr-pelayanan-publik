...
@section('container')
    <h1 class="btr-page-title">Profil - Fasilitas <small>Tambah Fasilitas</small></h1>

    <div class="btr-card">
        <form method="post" action="{{ url('dashboard/fasilitas-balai') }}" enctype="multipart/form-data">
            @csrf
