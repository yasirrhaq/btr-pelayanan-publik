...
@section('container')
    <h1 class="btr-page-title">Profil - Fasilitas</h1>

    <div class="btr-card">
        <div class="btr-toolbar">
            <a href="{{ url('dashboard/fasilitas-balai/create') }}" class="btr-btn">
        ...
        <div class="btr-table-wrap">
            <table class="btr-table">
                ...
                <tbody>
                    @forelse ($fasilitasBalai as $items)
                        <tr>
                            ...
                            <td>
                                <div class="btr-actions">
                                    <form action="{{ url('dashboard/fasilitas-balai/' . $items->id) }}" method="post" class="btr-action-form" onsubmit="return confirm('Yakin hapus data?')">
                                        @csrf
                                        @method('delete')
                                    ...
                                    <a href="{{ url('dashboard/fasilitas-balai/' . $items->id . '/edit') }}" class="btr-action edit" title="Edit">
                                    ...
                                    <a href="{{ url('dashboard/fasilitas-balai/' . $items->id) }}" class="btr-action view" title="Lihat">
                    ...
                    @empty
                        <tr><td colspan="6" style="color:var(--text-muted);padding:28px">Belum ada fasilitas.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
