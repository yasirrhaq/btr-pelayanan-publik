...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Struktur Organisasi Baru</h1>
    </div>

    <div class="col-lg-8">
        <form method="post" action="{{url('')}}/dashboard/struktur-organisasi" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary">Buat Struktur Organisasi</button>
        </form>
    </div>
