...
@section('container')
    <h1 class="btr-page-title">Profil - SDM <small>Tambah Struktur Organisasi</small></h1>

    <div class="btr-card">
        <form method="post" action="{{ url('dashboard/struktur-organisasi') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="btr-form-group">
                <label class="btr-label">Unggah Gambar <small style="color:var(--text-muted)">(Max 1MB)</small></label>
